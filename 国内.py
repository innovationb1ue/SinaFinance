...
URL_PATTERN = 'http://feed.mix.sina.com.cn/api/roll/get?pageid=155&lid=1688&num=50&page=PAGENUM'
...
if __name__ == '__main__':
    ...
    # 执行coroutine
    loop.run_until_complete(asyncio.wait([main(i) for i in range(1,47)]))
    loop.close()
    FP.close()
